...
export function FeatureCard({ 
  ...
  const variantClasses = {
    default: "border-border/50 hover:border-border transition-all duration-300 hover:shadow-medium bg-card",
    primary: "border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10 hover:from-primary/10 hover:to-primary/15 transition-all duration-300 hover:shadow-medium hover:shadow-primary/10",
    accent: "border-accent/20 bg-gradient-to-br from-accent/5 to-accent/10 hover:from-accent/10 hover:to-accent/15 transition-all duration-300 hover:shadow-medium hover:shadow-accent/10",
    elevated: "border-border/30 bg-card shadow-medium hover:shadow-large transition-all duration-300 hover:-translate-y-1"
  }
  ...
  const iconVariants = {
    ...
    elevated: "bg-gradient-to-br from-primary/10 to-accent/10 text-primary group-hover:from-primary group-hover:to-accent group-hover:text-primary-foreground"
  }
    ...
    <Card className={cn(
      ...
      <CardHeader className="text-center space-y-4 relative">
        <div className={cn(
          ...
          <div className="text-lg [&>svg]:h-6 [&>svg]:w-6">
            {icon}
          </div>
        </div>
