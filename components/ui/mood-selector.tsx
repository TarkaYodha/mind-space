...
export function MoodSelector({ value, onChange, className }: MoodSelectorProps) {
  const moods = [
    ...
    { value: 4, emoji: "😕", label: "Below Average", color: "hover:bg-orange-100 hover:border-orange-300" },
    { value: 5, emoji: "😐", label: "Neutral", color: "hover:bg-yellow-100 hover:border-yellow-300" },
    ...
    { value: 9, emoji: "😁", label: "Excellent", color: "hover:bg-green-100 hover:border-green-300" },
    { value: 10, emoji: "🤗", label: "Amazing", color: "hover:bg-green-100 hover:border-green-300" }
  ]
