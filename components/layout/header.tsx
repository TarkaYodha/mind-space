...
export function Header({ className, showAuth = true }: HeaderProps) {
  ...
  const navigation = [
    { name: "Dashboard", href: "/dashboard", description: "Your mental health hub" },
        { name: "AI Chat", href: "/chat", description: "Talk with our AI support assistant" },
    { name: "Tools", href: "/tools", description: "Wellness and mental health tools" },
    { name: "Assessments", href: "/assessments", description: "Evaluate your mental health" },
    { name: "Mood", href: "/mood", description: "Track and monitor your mood" },
    { name: "Forums", href: "/forums", description: "Connect with the community" },,
    { name: "Crisis Help", href: "/emergency", description: "24/7 emergency support" },
  ]
        ...
        <div className="flex h-16 lg:h-18 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group transition-all duration-300 hover:scale-105">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-xl text-foreground leading-none group-hover:text-primary transition-colors duration-300">MindSpace</span>
