        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid gap-8 md:grid-cols-2 mb-12 max-w-6xl mx-auto">
            {assessments.map((assessment, idx) => (
              ...
              >
                ...
                <h3 className="font-subheading text-2xl font-semibold text-slate-800 mb-2">{assessment.name}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <h4 className="font-subheading text-xl font-semibold text-blue-950 mb-2">Discuss Results</h4>
            ...
            >
              ...
              <h4 className="font-subheading text-xl font-semibold text-blue-950 mb-2">Use Wellness Tools</h4>
              <p className="text-sm text-slate-600 mb-4">
            ...
            >
              ...
              <h4 className="font-subheading text-xl font-semibold text-blue-950 mb-2">Learn More</h4>
              <p className="text-sm text-slate-600 mb-4">
