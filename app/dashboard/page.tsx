      ...
      <section className="w-full bg-gradient-to-b from-white to-blue-50 py-20 pt-28">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
            ...
            {quickActions.map((action, idx) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-subheading text-xl font-semibold text-slate-800">{action.title}</h3>
                  {action.badge && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {wellnessTools.map((tool, idx) => (
              ...
              >
                ...
                <h4 className="font-subheading text-xl font-semibold text-blue-950 mb-2">{tool.title}</h4>
          ...
          <div className="bg-red-50 border border-red-200 rounded-2xl p-8 text-center mb-12">
            ...
            <h3 className="font-subheading text-3xl font-bold text-red-700 mb-2">Crisis Support Available 24/7</h3>
            ...
            {learningResources.map((resource, idx) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <h5 className="font-subheading text-lg font-semibold text-slate-800">{resource.title}</h5>
