...
import { Clock, Star, Play, Heart, Users } from "lucide-react";
...
export default function Activities() {
  ...
  const yogaAsanas = [
    {
      ...
      duration: "5 min",
      difficulty: "Beginner",
      description: "A gentle side stretch that improves flexibility and releases tension in the spine.",
    ...
    },
    {
      ...
      duration: "3 min",
      difficulty: "Beginner",
      description: "Classic yoga pose that strengthens arms and shoulders while stretching the entire body.",
  ...
  const calmingMusic = [
    ...
    },
    {
      ...
      duration: "15 min",
      genre: "Healing",
      description: "Traditional Tibetan singing bowls create harmonic vibrations for deep relaxation.",
    ...
    },
    {
      ...
      duration: "25 min",
      genre: "Instrumental",
      description: "Soft instrumental music inspired by Japanese zen gardens and mindfulness practice.",
  ...
  const YogaCard: React.FC<YogaCardProps> = ({ name, image, duration, difficulty, description, benefits }) => (
    <motion.div
    ...
    >
      <div className="relative overflow-hidden">
        <img 
          ...
          loading="lazy"
          onError={(e) => {
            e.currentTarget.src = 'https://images.unsplash.com/photo-1506629905607-74f47903b2e9?w=400&h=300&fit=crop&crop=center';
          }}
        />
      ...
      <div className="p-6">
        <h3 className="font-subheading text-2xl text-[#001f4d] mb-2">{name}</h3>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            {benefits.slice(0, 3).map((benefit, index) => (
              <span key={index} className="bg-indigo-50 text-indigo-700 text-xs px-3 py-1 rounded-full font-medium">
                {benefit}
              </span>
            ))}
          </div>
  ...
  const MantraCard: React.FC<MantraCardProps> = ({ title, sanskrit, meaning, purpose, duration }) => (
    <motion.div
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-subheading text-2xl text-[#001f4d]">{title}</h3>
  ...
  const MusicCard: React.FC<MusicCardProps> = ({ title, artist, duration, genre, description, mood }) => (
    <motion.div
      initial={{ opacity: 0, y: 30 }}
      whileInView={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    ...
    <>
      ...
      <section className="w-full bg-gradient-to-b from-white to-blue-50 py-20 pt-32">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            <h1 className="font-heading text-4xl sm:text-5xl  mt-5 lg:text-6xl mb-4 text-black">
              Mindful Activities
            </h1>
            <h2 className="font-subheading text-3xl sm:text-4xl mb-6 text-[#001f4d]">
              Find Your Inner Peace
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Discover inner peace through yoga, mantras, and calming music. Your journey to mindfulness starts here with carefully curated activities designed for your well-being.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div className="text-center">
                <motion.h2 
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="font-subheading text-4xl text-[#001f4d] mb-4"
                >
                  Yoga Asanas for Mindfulness
                </motion.h2>
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Practice these beautiful poses to strengthen your body and calm your mind. Each asana is designed to bring balance and peace.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {yogaAsanas.map((asana, index) => (
                  <YogaCard key={index} {...asana} />
                ))}
              </div>
            </div>
          )}
          ...
          {activeTab === 'mantras' && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Recite these ancient mantras to find inner peace and spiritual connection. Let the vibrations guide you to tranquility.
                </p>
              </div>
          ...
          {activeTab === 'music' && (
            <div className="space-y-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Immerse yourself in peaceful music and nature sounds for meditation and relaxation. Let the sounds wash away your stress.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
      ...
      <section className="bg-gradient-to-r from-indigo-50 to-blue-50 py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          >
            <h2 className="font-subheading text-4xl text-[#001f4d] mb-4">
              Ready to Begin Your Journey?
            </h2>
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of students who have found peace and clarity through our mindful activities. Start your transformation today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/chat" className="bg-[#001f4d] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#001437] transition-colors">
                Start Free Trial
              </Link>
              <Link href="/dashboard" className="bg-[#001f4d] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#001437] transition-colors">
                Dashboard
              </Link>
            </div>
          </motion.div>
