...
import { MailIcon, PhoneIcon, ClockIcon, ShieldIcon, AlertTriangleIcon } from "lucide-react"
      ...
      <Section padding="xl">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <TypographyLead className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Get in touch with our support team, report issues, or inquire about partnerships. We're here to help.
          </TypographyLead>
        </div>
      </Section>
          ...
          <Card className="border-red-200 bg-red-50 dark:bg-red-950/20 dark:border-red-800">
            <CardHeader>
              ...
              <CardDescription className="text-red-600 dark:text-red-300">
                If you're in immediate danger or having thoughts of suicide, please contact emergency services immediately.
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <Section background="muted">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <TypographyH2 className="text-3xl sm:text-4xl mb-4">
              How to Reach Us
            </TypographyH2>
            <TypographyP className="text-muted-foreground max-w-2xl mx-auto">
              Choose the best contact method for your needs. All inquiries are handled confidentially.
            </TypographyP>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {contactMethods.map((method, index) => (
              <Card key={index} className={method.urgent ? "border-orange-200 bg-orange-50 dark:bg-orange-950/20" : ""}>
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <div className={`p-2 rounded-lg ${method.urgent ? "bg-orange-100 dark:bg-orange-900/50" : "bg-primary/10"}`}>
                      <div className={method.urgent ? "text-orange-600 dark:text-orange-400" : "text-primary"}>
                        {method.icon}
                      </div>
                    </div>
                    <div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All form submissions are confidential and secure.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form className="space-y-6">
                ...
                <div className="text-sm text-muted-foreground bg-muted p-4 rounded-lg">
                  <strong>Privacy Note:</strong> This form is secure and confidential. We never share personal information and will only use your contact details to respond to your inquiry.
                </div>
      ...
      <Section background="muted">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <TypographyH2 className="text-3xl sm:text-4xl">
              Connect With Us
            </TypographyH2>
            <TypographyP className="text-muted-foreground">
