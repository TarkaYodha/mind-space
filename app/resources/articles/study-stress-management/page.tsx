...
import { ArrowLeftIcon, ClockIcon, BookOpenIcon, AlertTriangleIcon, CheckCircleIcon } from "lucide-react"
    ...
    <>
      ...
      <section className="py-16"><div className="max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <TypographyP>
            Study stress is the psychological and physical tension that arises from academic demands, deadlines, 
            and performance pressure. While some stress can motivate learning, chronic study stress can impair 
            cognitive function, memory consolidation, and overall academic performance. Understanding how to 
            manage this stress is essential for both academic success and mental health.
          </TypographyP>
          ...
          <Card className="my-6 border-amber-200 bg-amber-50 dark:bg-amber-950/20">
            ...
            <CardContent>
              <TypographyP className="text-sm text-amber-800 dark:text-amber-200 mb-0">
                Research shows that moderate stress can enhance focus and memory formation, but excessive stress 
                floods the brain with cortisol, impairing the hippocampus (memory center) and prefrontal cortex 
                (executive function). The key is finding your optimal stress level for peak performance.
              </TypographyP>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <span className="bg-primary text-primary-foreground w-6 h-6 rounded-full flex items-center justify-center text-xs">P</span>
                    Prioritize Tasks
                  </h4>
                  <p className="text-muted-foreground">Use the Eisenhower Matrix: Urgent/Important, Important/Not Urgent, Urgent/Not Important, Neither</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <span className="bg-primary text-primary-foreground w-6 h-6 rounded-full flex items-center justify-center text-xs">O</span>
                    Organize Your Schedule
                  </h4>
                  <p className="text-muted-foreground">Block time for studying, breaks, meals, and personal care. Include buffer time for unexpected challenges.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <span className="bg-primary text-primary-foreground w-6 h-6 rounded-full flex items-center justify-center text-xs">W</span>
                    Work in Focused Blocks
                  </h4>
                  <p className="text-muted-foreground">Use techniques like Pomodoro (25 min work, 5 min break) to maintain concentration and prevent burnout.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <span className="bg-primary text-primary-foreground w-6 h-6 rounded-full flex items-center justify-center text-xs">E</span>
                    Evaluate Progress Regularly
                  </h4>
                  <p className="text-muted-foreground">Weekly reviews help adjust your approach and celebrate accomplishments.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                    <span className="bg-primary text-primary-foreground w-6 h-6 rounded-full flex items-center justify-center text-xs">R</span>
                    Rest and Recharge
                  </h4>
                  <p className="text-muted-foreground">Schedule adequate sleep, exercise, and relaxation. Recovery time is productive time.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Lighting:</strong> Natural light when possible, consistent bright lighting for evening study</li>
                  <li><strong>Temperature:</strong> Slightly cool (68-72°F) to promote alertness</li>
                  <li><strong>Seating:</strong> Comfortable but not too relaxed; good posture support</li>
                  <li><strong>Organization:</strong> Clean, clutter-free space with necessary materials accessible</li>
                  <li><strong>Noise:</strong> Find your optimal level - silence, white noise, or instrumental music</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Device management:</strong> Use website blockers during study sessions</li>
                  <li><strong>Notification control:</strong> Turn off non-essential notifications</li>
                  <li><strong>App organization:</strong> Remove distracting apps from immediate access</li>
                  <li><strong>Study apps:</strong> Use tools like Forest, Cold Turkey, or Freedom</li>
                  <li><strong>Digital notes:</strong> Organize files clearly; backup regularly</li>
                </ul>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-muted/50 p-6 rounded-lg my-6">
            ...
            <div className="space-y-3 text-sm">
              <div><strong>Survey:</strong> Skim headings, summaries, and key points before reading</div>
              <div><strong>Question:</strong> Turn headings into questions you want to answer</div>
              <div><strong>Read:</strong> Read actively, looking for answers to your questions</div>
              <div><strong>Recite:</strong> Summarize what you've learned in your own words</div>
              <div><strong>Review:</strong> Go back over material to reinforce learning</div>
            </div>
          </div>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Review material at increasing intervals (1 day, 3 days, 1 week, 2 weeks) for long-term retention.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Interleaving:</h4>
                  <p className="text-muted-foreground">Mix different types of problems or subjects within study sessions to improve pattern recognition.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Elaborative Interrogation:</h4>
                  <p className="text-muted-foreground">Ask "why" and "how" questions about the material to deepen understanding.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Dual Coding:</h4>
                  <p className="text-muted-foreground">Combine visual and verbal information through diagrams, mind maps, and mnemonics.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Sleep debt impairs:</strong> Memory consolidation, attention, decision-making</li>
                  <li><strong>Optimal sleep:</strong> 7-9 hours per night for most college students</li>
                  <li><strong>Sleep hygiene:</strong> Consistent bedtime, cool dark room, no screens 1 hour before bed</li>
                  <li><strong>Power naps:</strong> 10-20 minutes can restore alertness without grogginess</li>
                  <li><strong>Sleep before exams:</strong> Better than pulling all-nighters</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Regular meals:</strong> Prevent blood sugar crashes that impair concentration</li>
                  <li><strong>Brain foods:</strong> Omega-3s, berries, nuts, leafy greens, whole grains</li>
                  <li><strong>Hydration:</strong> Even mild dehydration affects cognitive performance</li>
                  <li><strong>Limit caffeine:</strong> 1-2 cups coffee max; avoid late in day</li>
                  <li><strong>Study snacks:</strong> Protein + complex carbs for sustained energy</li>
                </ul>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="my-6 border-green-200 bg-green-50 dark:bg-green-950/20">
            ...
            <CardContent>
              <div className="space-y-3 text-sm text-green-800 dark:text-green-200">
                <p><strong>Immediate benefits:</strong> 20 minutes of moderate exercise increases focus and mood for up to 2 hours</p>
                <p><strong>Long-term benefits:</strong> Regular exercise improves memory, reduces anxiety, and increases stress resilience</p>
                <p><strong>Study integration:</strong> Walking meetings, standing desk, exercise breaks between study sessions</p>
                <p><strong>Stress relief:</strong> Physical activity is one of the most effective stress reduction strategies</p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="bg-muted/50 p-6 rounded-lg my-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              <div>
                <h5 className="font-semibold text-red-600 dark:text-red-400 mb-2">Fixed Mindset (Increases Stress):</h5>
                <ul className="space-y-1 text-muted-foreground">
              ...
              <div>
                <h5 className="font-semibold text-green-600 dark:text-green-400 mb-2">Growth Mindset (Reduces Stress):</h5>
                <ul className="space-y-1 text-muted-foreground">
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Self-kindness:</strong> Speak to yourself as you would a good friend facing the same challenge</li>
            <li><strong>Common humanity:</strong> Remember that struggling with difficult material is part of the learning process</li>
            <li><strong>Mindfulness:</strong> Acknowledge difficult emotions without being overwhelmed by them</li>
            <li><strong>Perspective:</strong> View setbacks as temporary and specific, not permanent and global</li>
          </ul>
          ...
          <Card className="my-6 border-orange-200 bg-orange-50 dark:bg-orange-950/20">
            ...
            <CardContent>
              <div className="space-y-2 text-sm text-orange-800 dark:text-orange-200">
                <div>• Study stress significantly impacts daily functioning or relationships</div>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Effective study stress management is about working smarter, not just harder. The goal isn't to 
                  eliminate all stress—some stress motivates learning. Instead, focus on building sustainable 
                  habits that support both your academic success and overall well-being. Small, consistent 
                  changes in how you approach studying can lead to significant improvements in both performance 
                  and stress levels.
                </p>
              </div>
            </CardContent>
