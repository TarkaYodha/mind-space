...
import { ArrowLeftIcon, ClockIcon, BookOpenIcon, BrainIcon, HeartIcon } from "lucide-react"
    ...
    <>
      ...
      <section className="py-16"><div className="max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <TypographyP>
            Mindfulness is the practice of purposefully paying attention to the present moment without judgment. 
            For college students, it's a powerful tool to manage stress, improve focus, and enhance emotional 
            well-being. Research shows that regular mindfulness practice can reduce anxiety, improve academic 
            performance, and increase overall life satisfaction.
          </TypographyP>
          ...
          <Card className="my-6">
            <CardHeader>
              <CardTitle className="text-lg">Perfect for: Starting your day with intention</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div><strong>1.</strong> Sit comfortably in bed or a chair</div>
                    <div><strong>2.</strong> Take three deep breaths to center yourself</div>
                    <div><strong>3.</strong> Set an intention for your day (e.g., "I will approach challenges with curiosity")</div>
                    <div><strong>4.</strong> Spend 2-3 minutes focusing on your breath</div>
                    <div><strong>5.</strong> Notice any thoughts without judging them, then return to your breath</div>
                    <div><strong>6.</strong> End by taking a moment to appreciate starting your day mindfully</div>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Mindful Steps:</strong> Feel your feet touching the ground with each step</li>
            <li><strong>Sensory Awareness:</strong> Notice sounds, sights, and sensations around you</li>
            <li><strong>Breath Connection:</strong> Coordinate your breathing with your walking rhythm</li>
            <li><strong>Present Moment:</strong> When your mind wanders to upcoming classes, gently return to the walking experience</li>
          </ul>
          ...
          <Card className="my-6">
            <CardHeader>
              <CardTitle className="text-lg">Use when feeling overwhelmed or stressed</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Pause whatever you're doing</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Take one or more conscious breaths</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-blue-100 dark:bg-blue-900/50 rounded-full flex items-center justify-center">
                        <span className="text-blue-600 dark:text-blue-400 font-bold text-sm">O</span>
                      </div>
                      <div>
                        <h4 className="font-semibold">Observe</h4>
                        <p className="text-sm text-muted-foreground">Notice your thoughts and feelings</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Continue with awareness and intention</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-muted/50 p-6 rounded-lg my-6">
            ...
            <div className="space-y-2 text-sm">
              <div><strong>1.</strong> Lie down comfortably in your dorm room</div>
              <div><strong>2.</strong> Close your eyes and take several deep breaths</div>
              <div><strong>3.</strong> Start at the top of your head, noticing any sensations</div>
              <div><strong>4.</strong> Slowly move your attention down through your body</div>
              <div><strong>5.</strong> Spend 30 seconds on each body part (forehead, eyes, jaw, neck, shoulders, etc.)</div>
              <div><strong>6.</strong> Don't try to change anything, just notice what you feel</div>
              <div><strong>7.</strong> End by taking a few deep breaths and slowly opening your eyes</div>
            </div>
          </div>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground italic">"May I be happy. May I be healthy. May I be at peace. May I be free from suffering."</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">2. Think of someone you love:</h4>
                  <p className="text-muted-foreground italic">"May you be happy. May you be healthy. May you be at peace. May you be free from suffering."</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">3. Think of a neutral person (classmate, cashier):</h4>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground italic">Repeat the same phrases (this may feel challenging)</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">5. Extend to all beings:</h4>
                  <p className="text-muted-foreground italic">"May all beings be happy, healthy, at peace, and free from suffering."</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Before studying:</strong> Take 2 minutes to set an intention and clear your mind</li>
            <li><strong>During breaks:</strong> Practice mindful breathing instead of scrolling social media</li>
            <li><strong>When frustrated:</strong> Use the STOP technique before continuing</li>
            <li><strong>After studying:</strong> Take a moment to appreciate your effort, regardless of results</li>
          </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <Card>
              ...
              <CardContent className="text-sm">
                <p><strong>Solution:</strong> Start with just 2-3 minutes. Practice during activities you already do (walking, waiting, eating).</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <p><strong>Solution:</strong> A busy mind is normal! The goal isn't to stop thoughts, but to notice them without judgment.</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <p><strong>Solution:</strong> Set phone reminders, use apps, or tie practice to existing habits (after brushing teeth).</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <p><strong>Solution:</strong> Benefits often develop gradually. Keep a simple journal noting your stress levels and mood.</p>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Mindfulness is a practice, not a performance. Be patient and kind with yourself as you develop 
                  this skill. Even a few minutes of mindfulness can make a meaningful difference in your college 
                  experience. Start where you are, and let your practice grow naturally over time.
                </p>
              </div>
            </CardContent>
          </Card>
