...
import { ArrowLeftIcon, ClockIcon, BookOpenIcon, HeartIcon, UsersIcon, PhoneIcon } from "lucide-react"
    ...
    <>
      ...
      <section className="py-16"><div className="max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <TypographyP>
            Loneliness is one of the most common experiences among college students, yet it's often kept secret due to 
            shame or stigma. Studies show that over 60% of college students report feeling lonely, and these feelings 
            have increased significantly in recent years. Understanding that loneliness is both normal and manageable 
          ...
          <Card className="my-6 border-blue-200 bg-blue-50 dark:bg-blue-950/20">
            ...
            <CardContent>
              <TypographyP className="text-sm text-blue-800 dark:text-blue-200 mb-0">
                Loneliness doesn't mean you're antisocial, weird, or unlikeable. It's a natural human emotion that 
                signals our need for connection. Even people who appear popular and social can experience deep loneliness. 
                Recognizing this is part of your healing journey.
              </TypographyP>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <Card>
              ...
              <CardContent className="text-sm">
                <p className="mb-3"><strong>What it is:</strong> Lacking a network of friends or social connections</p>
                <p className="mb-3"><strong>Common triggers:</strong> Moving away from home, difficulty making new friends, social anxiety</p>
                <p className="text-muted-foreground italic">Focus on building new friendships and social networks.</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <p className="mb-3"><strong>What it is:</strong> Missing deep, intimate connections and understanding</p>
                <p className="mb-3"><strong>Common triggers:</strong> Distance from family, lack of close confidants, surface-level relationships</p>
                <p className="text-muted-foreground italic">Focus on deepening existing relationships and finding meaningful connections.</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <p className="mb-3"><strong>What it is:</strong> Feeling disconnected from purpose, meaning, or your authentic self</p>
                <p className="mb-3"><strong>Common triggers:</strong> Major life transitions, questioning identity, feeling misunderstood</p>
                <p className="text-muted-foreground italic">Focus on self-discovery, values exploration, and finding your place in the world.</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <p className="mb-3"><strong>What it is:</strong> Temporary loneliness due to specific circumstances</p>
                <p className="mb-3"><strong>Common triggers:</strong> Roommate conflicts, relationship breakups, friend group changes</p>
                <p className="text-muted-foreground italic">Focus on addressing the specific situation and building resilience.</p>
              </CardContent>
            </Card>
          </div>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Leaving home support systems:</strong> Distance from family and high school friends</li>
            <li><strong>New environment:</strong> Unfamiliar campus, different culture, academic pressures</li>
            <li><strong>Identity shifts:</strong> Questioning who you are without familiar roles and relationships</li>
            <li><strong>Independence overwhelm:</strong> Sudden responsibility for all aspects of life</li>
          </ul>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Many college social interactions remain at small-talk level, leaving you feeling unseen.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Comparison and Competition:</h4>
                  <p className="text-muted-foreground">Academic and social pressure can make relationships feel competitive rather than supportive.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Digital Connection Paradox:</h4>
                  <p className="text-muted-foreground">Being constantly "connected" online while feeling emotionally disconnected.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Mismatched Expectations:</h4>
                  <p className="text-muted-foreground">Expecting college friendships to immediately match the depth of long-term relationships.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="bg-muted/50 p-6 rounded-lg my-6">
            ...
            <div className="space-y-2 text-sm">
              <div><strong>Day 1:</strong> Make eye contact and smile at someone in class</div>
              <div><strong>Day 2:</strong> Say hello to the same person</div>
              <div><strong>Day 3:</strong> Ask a simple question ("How did you find today's lecture?")</div>
              <div><strong>Day 4:</strong> Share something small about yourself</div>
              <div><strong>Day 5:</strong> Suggest studying together or grabbing coffee</div>
            </div>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>One close confidant:</strong> Someone you can be vulnerable with</li>
            <li><strong>2-3 regular companions:</strong> People you enjoy spending time with</li>
            <li><strong>Several acquaintances:</strong> Friendly faces who brighten your day</li>
            <li><strong>Study partners:</strong> People who share your academic goals</li>
            <li><strong>Activity partners:</strong> Those who share your interests and hobbies</li>
          </ul>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Practice meditation, mindfulness, or quiet reflection to connect with yourself.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Solo Adventures:</h4>
                  <p className="text-muted-foreground">Visit museums, take walks, try new restaurants, or explore campus alone.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Skill Development:</h4>
                  <p className="text-muted-foreground">Learn something new, practice hobbies, or work on personal projects.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Self-Reflection:</h4>
                  <p className="text-muted-foreground">Journal about your experiences, values, and goals to deepen self-understanding.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <TypographyP>
            While loneliness is normal, it becomes problematic when it significantly impacts your daily functioning 
            or mental health. Consider seeking professional help if you experience:
          </TypographyP>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Practice active listening:</strong> Focus fully on others when they speak</li>
            <li><strong>Ask open-ended questions:</strong> Show genuine interest in others' experiences</li>
            <li><strong>Share appropriately:</strong> Gradually open up as relationships develop</li>
            <li><strong>Be reliable:</strong> Follow through on plans and commitments</li>
            <li><strong>Show appreciation:</strong> Thank people and acknowledge their kindness</li>
          </ul>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Close friends or family you can call during difficult times.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Regular Contact (3-5 people):</h4>
                  <p className="text-muted-foreground">Friends you see weekly or communicate with regularly.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Activity Partners (5-10 people):</h4>
                  <p className="text-muted-foreground">Classmates, club members, or hobby partners you enjoy spending time with.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Professional Support:</h4>
                  <p className="text-muted-foreground">Mental health professionals, advisors, or mentors you can turn to for guidance.</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">Available 24/7 for anyone experiencing emotional distress.</p>
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Loneliness is a temporary experience, not a permanent state. Every person you see on campus has 
                  felt lonely at some point. Building meaningful connections takes time, patience, and self-compassion. 
                  Start small, be authentic, and remember that the right people will appreciate you for who you are. 
