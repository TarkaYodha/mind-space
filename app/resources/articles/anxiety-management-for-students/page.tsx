...
import { ArrowLeftIcon, ClockIcon, BookOpenIcon, AlertTriangleIcon } from "lucide-react"
    ...
    <>
      ...
      <section className="py-16"><div className="max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <TypographyP>
            Academic anxiety is more than just pre-test jitters. It's a persistent feeling of worry, fear, 
            or unease about academic performance that can significantly impact your college experience. 
            Research shows that over 60% of college students experience academic anxiety at some point 
          ...
          <div className="space-y-4 my-6">
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Fear of not meeting expectations (your own or others'), worry about grades, 
                and comparison with peers can create intense pressure.
              </p>
            </div>
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Setting unrealistically high standards for yourself and fearing any mistakes 
                or perceived failures in academic work.
              </p>
            </div>
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Feeling like you don't belong in college or that you're not as capable as 
                your peers, despite evidence of your achievements.
              </p>
            </div>
          </div>
          ...
          <TypographyH2 className="text-xl mt-8 mb-4">Immediate Anxiety Management</TypographyH2>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Break large projects into smaller tasks:</strong> This makes them feel more manageable and provides regular opportunities for success.</li>
            <li><strong>Use active study techniques:</strong> Practice testing yourself, teaching others, and creating mind maps rather than just re-reading notes.</li>
            <li><strong>Create a realistic study schedule:</strong> Include buffer time for unexpected challenges and regular breaks.</li>
            <li><strong>Establish a consistent routine:</strong> Regular sleep, study, and meal times can reduce overall stress.</li>
            <li><strong>Prepare thoroughly but know when to stop:</strong> Over-studying can increase anxiety rather than reduce it.</li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Maintain perspective:</strong> Remember that grades don't define your worth as a person</li>
            <li><strong>Practice self-compassion:</strong> Treat yourself with the same kindness you'd show a friend</li>
            <li><strong>Celebrate small wins:</strong> Acknowledge your efforts and progress, not just perfect outcomes</li>
            <li><strong>Learn from setbacks:</strong> View challenges as opportunities to grow rather than failures</li>
            <li><strong>Maintain balance:</strong> Engage in activities outside of academics that bring you joy</li>
          </ul>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Academic anxiety is treatable and manageable. With the right strategies and support, 
                  you can reduce your anxiety and improve both your academic performance and overall 
                  well-being. It's okay to ask for help—seeking support is a sign of wisdom, not weakness.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent className="pt-0">
                <Button variant="ghost" className="w-full justify-start p-0 h-auto" asChild>
                  <Link href="/resources/articles/stress-time-management">
                    Read Article →
                  </Link>
                </Button>
              </CardContent>
            ...
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent className="pt-0">
                <Button variant="ghost" className="w-full justify-start p-0 h-auto" asChild>
                  <Link href="/resources/articles/breathing-techniques">
                    Read Article →
                  </Link>
                </Button>
              </CardContent>
