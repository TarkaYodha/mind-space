    ...
    <>
      ...
      <section className="py-16"><div className="max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <TypographyP>
            College can be one of the most exciting times in your life, but it can also be incredibly challenging. 
            The combination of academic pressure, social changes, financial stress, and newfound independence can 
            contribute to feelings of depression. You're not alone—studies show that approximately 30% of college 
            students experience significant symptoms of depression during their academic career.
          </TypographyP>

          <TypographyH3>Common Signs and Symptoms</TypographyH3>
          
          <TypographyP>
            Depression in college students can manifest in various ways. It's important to recognize that depression 
            isn't just feeling sad—it's a persistent condition that affects your thoughts, emotions, and daily functioning.
          </TypographyP>
          ...
          <div className="space-y-4 my-6">
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Increased workload, competitive environment, and fear of failure can overwhelm students 
                who previously excelled in high school.
              </p>
            </div>
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Leaving familiar social circles, difficulty making new friends, and relationship challenges 
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Sudden independence can be overwhelming, while questions about identity, career, and 
                future goals can create existential anxiety.
              </p>
            </div>
          </div>
          ...
          <TypographyP>
            If you've been experiencing several symptoms for more than two weeks, or if your symptoms 
            are interfering with your academic performance, relationships, or daily life, it's time to 
          ...
          <Card className="my-6 border-orange-200 bg-orange-50 dark:bg-orange-950/20">
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                <p><strong>Campus Counseling:</strong> Most colleges offer free counseling services</p>
                <p><strong>Crisis Hotline:</strong> 988 Suicide & Crisis Lifeline (call or text)</p>
                <p><strong>Crisis Text Line:</strong> Text HOME to 741741</p>
                <p><strong>Emergency:</strong> Call 911 or go to your nearest emergency room</p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Depression is a medical condition, not a personal failure. With proper support and treatment, 
                  you can recover and thrive in college and beyond. Take it one day at a time, and don't 
