...
import { ArrowLeftIcon, ClockIcon, BookOpenIcon, HeartHandshakeIcon, ShieldCheckIcon, AlertCircleIcon } from "lucide-react"
    ...
    <>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
          ...
          <TypographyP>
            Academic accommodations are modifications or adjustments to educational policies, practices, and 
            procedures that provide students with disabilities equal access to educational opportunities. 
            These accommodations level the playing field by removing barriers that might prevent students 
            from demonstrating their knowledge and abilities, without fundamentally altering the academic 
            requirements of courses or programs.
          </TypographyP>
          ...
          <Card className="my-6 border-blue-200 bg-blue-50 dark:bg-blue-950/20">
            ...
            <CardContent>
              <TypographyP className="text-sm text-blue-800 dark:text-blue-200 mb-0">
                ...
                qualified students with disabilities have the right to equal access to educational programs. 
                Colleges are required to provide reasonable accommodations that don't fundamentally alter 
                the nature of their programs or create an undue burden on the institution.
              </TypographyP>
            </CardContent>
          </Card>
          ...
          <TypographyP>
            The ADA defines disability broadly to include conditions that substantially limit one or more 
            major life activities. In the academic context, this includes conditions that affect learning, 
            reading, concentrating, thinking, communicating, or other cognitive functions.
          </TypographyP>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Reach out to your college's disability services office as early as possible, ideally before classes begin.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                  ...
                  <p className="text-muted-foreground">Provide professional documentation of your disability from qualified healthcare providers.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                  ...
                  <p className="text-muted-foreground">Meet with disability services staff to discuss your needs and determine appropriate accommodations.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                  ...
                  <p className="text-muted-foreground">Get official accommodation letters to provide to your professors and other relevant college staff.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2 flex items-center gap-2">
                  ...
                  <p className="text-muted-foreground">Work with professors to implement accommodations and follow up with disability services as needed.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <TypographyP>
            Effective documentation should be recent, comprehensive, and from qualified professionals. 
            Requirements vary by institution and type of disability, but generally include:
          </TypographyP>

          <div className="bg-muted/50 p-6 rounded-lg my-6">
            <h4 className="font-semibold mb-4">Essential Documentation Elements:</h4>
            <div className="space-y-3 text-sm">
              <div><strong>Professional credentials:</strong> Licensed healthcare provider qualified to diagnose your specific condition</div>
              <div><strong>Clear diagnosis:</strong> Specific diagnostic criteria met, using current diagnostic standards (DSM-5, ICD-11)</div>
              <div><strong>Functional limitations:</strong> How the condition impacts your academic performance and daily activities</div>
              <div><strong>Treatment history:</strong> Current and past treatments, medications, and their effects</div>
              <div><strong>Recommended accommodations:</strong> Professional's suggestions for academic support and modifications</div>
              <div><strong>Current impact:</strong> Recent assessment of how the condition affects your current functioning</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Extended time:</strong> Typically 1.5x or 2x the standard time</li>
                  <li><strong>Reduced distraction environment:</strong> Separate testing room</li>
                  <li><strong>Flexible scheduling:</strong> Alternative test dates or times</li>
                  <li><strong>Frequent breaks:</strong> Ability to pause during exams</li>
                  <li><strong>Alternative location:</strong> Disability services testing center</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Reader services:</strong> Having test questions read aloud</li>
                  <li><strong>Scribe services:</strong> Someone to write dictated answers</li>
                  <li><strong>Computer use:</strong> Typing instead of handwriting</li>
                  <li><strong>Large print materials:</strong> Enlarged test fonts</li>
                  <li><strong>Alternative formats:</strong> Digital or Braille materials</li>
                </ul>
              </CardContent>
            </Card>
          </div>
          ...
          <TypographyP>
            You are not required to disclose your specific disability to professors, but you do need to 
            provide them with your accommodation letter. Effective communication can help ensure your 
            accommodations are implemented properly.
          </TypographyP>

          <Card className="my-6">
            <CardHeader>
              <CardTitle className="text-lg">Best Practices for Professor Communication</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
          ...
          <div className="bg-muted/50 p-6 rounded-lg my-6">
            ...
            <div className="space-y-3 text-sm">
              <div><strong>Step 1:</strong> Communicate directly with the professor about specific concerns</div>
              <div><strong>Step 2:</strong> Contact your disability services coordinator for guidance</div>
              <div><strong>Step 3:</strong> Request a meeting between you, the professor, and disability services</div>
              <div><strong>Step 4:</strong> Consider modification of accommodations if current ones aren't effective</div>
              <div><strong>Step 5:</strong> If needed, pursue formal grievance procedures through your college</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Text-to-speech:</strong> Natural Reader, Read&Write, Voice Dream</li>
                  <li><strong>Speech-to-text:</strong> Dragon NaturallySpeaking, voice recognition</li>
                  <li><strong>Grammar and writing:</strong> Grammarly, Ginger, Hemingway Editor</li>
                  <li><strong>Organization:</strong> MindMeister, Inspiration, concept mapping</li>
                  <li><strong>PDF accessibility:</strong> Kurzweil, NVDA, screen readers</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm">
                <ul className="space-y-2">
                  <li><strong>Task management:</strong> Todoist, Any.do, Microsoft To-Do</li>
                  <li><strong>Time blocking:</strong> Google Calendar, Outlook, time-tracking apps</li>
                  <li><strong>Distraction blocking:</strong> Cold Turkey, Freedom, FocusMe</li>
                  <li><strong>Note-taking:</strong> OneNote, Notion, Evernote, audio recording</li>
                  <li><strong>Study aids:</strong> Quizlet, Anki, flashcard applications</li>
                </ul>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">Ergonomic keyboards, pencil grips, alternative computer mice, tablet writing tools</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Visual and Audio:</h4>
                  <p className="text-muted-foreground">Magnification software, colored overlays, noise-canceling headphones, FM systems</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Mobility and Access:</h4>
                  <p className="text-muted-foreground">Adjustable desks, ergonomic seating, portable ramps, accessibility features</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Environmental:</h4>
                  <p className="text-muted-foreground">Light filters, desk organizers, fidget tools, sensory supports</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <TypographyP>
            Mental health conditions can significantly impact academic performance, and accommodations can 
            provide crucial support during difficult periods.
          </TypographyP>
          ...
          <Card className="my-6 border-purple-200 bg-purple-50 dark:bg-purple-950/20">
            ...
            <CardContent>
              <div className="space-y-3 text-sm text-purple-800 dark:text-purple-200">
                <div><strong>Flexibility during episodes:</strong> Modified attendance, extended deadlines during acute symptoms</div>
                <div><strong>Testing support:</strong> Reduced distraction environment, breaks for anxiety management</div>
                <div><strong>Communication preferences:</strong> Email over in-person meetings, advance notice of changes</div>
                <div><strong>Crisis planning:</strong> Clear procedures for mental health emergencies</div>
                <div><strong>Therapeutic support:</strong> Time for counseling appointments, mental health days</div>
              </div>
            </CardContent>
          </Card>
          ...
          <TypographyP>
            Learning to advocate for yourself is a crucial skill that will serve you throughout college and 
            in your future career. Effective self-advocacy involves understanding your needs, communicating 
            them clearly, and working collaboratively to find solutions.
          </TypographyP>

          <div className="bg-muted/50 p-6 rounded-lg my-6">
            <h4 className="font-semibold mb-4">Self-Advocacy Components:</h4>
            <div className="space-y-3 text-sm">
              <div><strong>Self-awareness:</strong> Understanding your strengths, challenges, and learning style</div>
              <div><strong>Rights knowledge:</strong> Knowing your legal rights and institutional policies</div>
              <div><strong>Communication skills:</strong> Expressing needs clearly and professionally</div>
              <div><strong>Problem-solving:</strong> Working collaboratively to address challenges</div>
              <div><strong>Goal setting:</strong> Identifying specific outcomes you want to achieve</div>
              <div><strong>Resource awareness:</strong> Knowing where to find help and support</div>
            </div>
          </div>
            ...
            <CardContent>
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">College accommodation laws differ from K-12 special education laws. You must self-identify and advocate for your needs.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Documentation Updates:</h4>
                  <p className="text-muted-foreground">High school IEP/504 plans may not be sufficient. You may need new assessments from qualified professionals.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Independence Expectations:</h4>
                  <p className="text-muted-foreground">Greater responsibility for managing your accommodations, communicating with professors, and monitoring your progress.</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Support Network Changes:</h4>
                  <p className="text-muted-foreground">Building new relationships with disability services staff, professors, and peer support networks.</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <ul className="list-disc pl-6 space-y-2 my-4">
            <li><strong>Internship preparation:</strong> Practice requesting accommodations in work settings</li>
            <li><strong>Career counseling:</strong> Work with career services to identify disability-friendly employers</li>
            <li><strong>Workplace rights:</strong> Learn about ADA requirements for employers</li>
            <li><strong>Disclosure decisions:</strong> Develop strategies for when and how to disclose in job interviews</li>
            <li><strong>Skills documentation:</strong> Build portfolio showing your abilities and achievements</li>
          </ul>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Requesting accommodations is not asking for special treatment—it's ensuring equal access to 
                  educational opportunities. Your disability does not define your potential for success. With 
                  the right supports and accommodations, you can achieve your academic and career goals. Be 
                  patient with the process, advocate for your needs, and remember that seeking help is a sign 
            ...
            <Card className="hover:shadow-md transition-shadow">
              ...
              <CardContent className="pt-0">
                <Button variant="ghost" className="w-full justify-start p-0 h-auto" asChild>
                  <Link href="/resources/articles/study-stress-management">
                    Read Article →
                  </Link>
                </Button>
              </CardContent>
